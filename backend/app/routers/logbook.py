    ...
    if entry_in.entry_type == "INSPECTION" and entry_in.inspection_detail:
        ...
        for box_in in entry_in.inspection_detail.boxes:
            box = InspectionBox(
                ...
                brood_total=box_in.brood_total if box_in.brood_total is not None else -1,
                food_total=box_in.food_total if box_in.food_total is not None else -1,
                bee_total=box_in.bee_total if box_in.bee_total is not None else -1,
                drone_total=box_in.drone_total if box_in.drone_total is not None else -1,
                drone_brood_total=box_in.drone_brood_total if box_in.drone_brood_total is not None else -1,
                pollen_total=box_in.pollen_total if box_in.pollen_total is not None else -1,
