...
echo ""
printf "\033[1;36mStarte BeeBoard2 Unified Docker Stack mit:\033[0m\n"
printf "\033[1;36m  HTTP Port:        $HTTP_PORT\033[0m\n"
printf "\033[1;36m  HTTPS Port:       $HTTPS_PORT\033[0m\n"
printf "\033[1;36m  Datenverzeichnis: $DATA_DIR\033[0m\n"
echo ""
